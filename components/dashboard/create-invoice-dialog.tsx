              ...
              <div className='fixed inset-0 z-100 overflow-y-auto'>
                <div className='flex min-h-full items-start justify-center p-4 pt-12'>
                  ...
                  <motion.div
                    ...
                    className='relative w-full max-w-xl rounded-3xl border border-border/40 bg-card/60 p-6 shadow-2xl outline-none ring-1 ring-white/5 backdrop-blur-xl'
                  >
                    ...
                    {result ? (
                      <div className='space-y-6'>
                        <div className='flex flex-col items-center justify-center rounded-2xl border border-border/30 bg-muted/10 py-6'>
                          ...
                          <p className='text-sm font-medium tracking-tight text-foreground'>Invoice created</p>
                        ...
                        <div className='flex items-center gap-2 rounded-2xl border border-border/50 bg-background/50 p-3 ring-1 ring-border/20'>
                          <span className='ml-2 flex-1 truncate font-mono text-sm text-muted-foreground'>
                            {invoiceUrl}
                          </span>
                          <Button
